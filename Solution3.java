...
public class Solution3 {
    ...
    Также в классе Solution3 есть константа HEX, которая содержит в себе все символы, используемые в шестнадцатеричной системе.
    ...
    */
    ...
    public static int decimalNumber = 1256;
    public static String hexNumber = "4e8";
